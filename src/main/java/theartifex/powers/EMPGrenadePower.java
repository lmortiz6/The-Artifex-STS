...
public class EMPGrenadePower extends BasePower {

    public static final String POWER_ID = makeID(EMPGrenadePower.class.getSimpleName());
    private static final PowerType TYPE = PowerType.BUFF;
    private static final boolean TURN_BASED = true;
    private final int damage;
    private static int bombIdOffset;

    public EMPGrenadePower(AbstractCreature owner, AbstractCreature source, int amount, int magicNumber){
