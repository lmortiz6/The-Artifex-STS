...
import static theartifex.TheArtifexMod.characterPath;
import static theartifex.TheArtifexMod.makeID;

public class TheArtifexCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Artifex"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass ARTIFEX;
        @SpireEnum(name = "ARTIFEX_MYRTLE") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "ARTIFEX_MYRTLE") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheArtifexCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public TheArtifexCharacter() {
        super(getNames()[0], Meta.ARTIFEX,
    ...
    public AbstractPlayer newInstance() {
        ...
        return new TheArtifexCharacter();
    }
}
